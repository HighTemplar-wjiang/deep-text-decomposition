...
Modified for Image decomposition by HighTemplar-wjiang
"""
...
class UnetSkipConnectionBlock(nn.Module):
    ...
    def __init__(self, outer_nc, inner_nc, input_nc=None, conv_stride=2,
        ...
        downconv = nn.Conv2d(input_nc, inner_nc, kernel_size=4,
                             stride=conv_stride, padding=1, bias=use_bias)
        ...
        if outermost:
            upconv = nn.ConvTranspose2d(inner_nc * 2, outer_nc,
                                        kernel_size=4, stride=conv_stride,
                                        padding=1, bias=True)
            # outputconv = nn.Conv2d(outer_nc, outer_nc, kernel_size=1, stride=1, padding=0, bias=True)
