...
class MinimumDiceLoss:
    ...
    def forward(self, batch, G_pred1, G_pred2):
        ...
        # compute loss on each img
        loss_1 = self.criterion(G_pred1, target_1) + self.criterion(G_pred2, target_2)

        # exchange order and compute loss
        loss_2 = self.criterion(G_pred1, target_2) + self.criterion(G_pred2, target_1)
